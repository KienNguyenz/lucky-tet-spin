...
export const defaultRewards = [
    { id: 1, label: "100,000₫", value: 100000, weight: 30, color: "#FFEB3B" },
    { id: 2, label: "200,000₫", value: 200000, weight: 30, color: "#D32F2F" },
    { id: 3, label: "500,000₫", value: 500000, weight: 20, color: "#D32F2F" },
    { id: 4, label: "1,000,000₫", value: 1000000, weight: 20, color: "#D32F2F" },
];
