...
export const defaultRewards = [
    { id: 3, label: "50,000₫", value: 50000, weight: 28, color: "#FFEB3B" },
    { id: 1, label: "100,000₫", value: 100000, weight: 35, color: "#FFEB3B" },
    { id: 2, label: "200,000₫", value: 200000, weight: 30, color: "#D32F2F" },
    { id: 6, label: "500,000₫", value: 500000, weight: 5, color: "#D32F2F" },
    { id: 4, label: "1,000,000₫", value: 1000000, weight: 2, color: "#D32F2F" },
];
